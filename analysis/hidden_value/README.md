...
- **Underrated Now** — the claim rests on the role-adjusted residual. Higher confidence.
- **Trending Up** — the claim rests on a ten-window trend. Lower confidence by nature; a
  shortlist to watch rather than a conclusion.
...
| `trajectory_score` | Shrunk trend across production, efficiency, opportunity and projection |
...
- **`Trending Up` is the weaker track.** Ten windows is thin even after shrinkage.
