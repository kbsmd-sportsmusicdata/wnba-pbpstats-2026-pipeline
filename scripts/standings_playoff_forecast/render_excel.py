...
def _model_notes_sheet(workbook: Workbook, frames: Mapping[str, pd.DataFrame], cfg: object, manifest: dict) -> None:
    ...
    rows = [
        ...
        ["PBPStats contextual status", manifest.get("pbpstats_enrichment_status")],
        ["PBPStats provenance kind", manifest.get("pbpstats_provenance_kind")],
        ...
        ["Strength definition", "Composite strength is explanatory; game-derived predictive NetRtg drives matchup expected margin upstream. PBPStats fields are contextual only."],
